...
const About = () => {
  ...
  return (
    <>
      <div className="h-full hidden bg-primary/30  py-32 text-center xl-text-left ">
        {/* avatar image */}
        {/* <motion.div
        ...
        <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 ">
          ...
          <div className="flex-1 flex flex-col justify-center xl:text-left">
            ...
            >
              ...
              ipsa, explicabo placeat officiis quod quae! Alias, ad, ipsam velit
              excepturi numquam cum maiores officia nesciunt vel ea autem ab
              veritatis. Est illum beatae fugiat consequuntur asperiores autem
              deserunt officiis accusantium, nemo eius unde placeat laboriosam
              tempore consectetur hic dolore dolor porro molestias. Vero ipsam
              quo eius quaerat odio. Aliquid, corrupti?
            </motion.p>
            {/* counter */}
            <motion.div
            ...
            <div className="flex  flex-col xl:flex-row gap-x-8">
              ...
              <div className="text-center flex xl:w-[30vw] flex-col xl:text-left items-center mb-4 xl:mb-0 ">
                ...
                >
                  ...
                  iste beatae? Porro, eum impedit sunt pariatur dolore
                  accusantium numquam autem illum nisi quis. Sequi iste quasi,
                  minus neque minima dicta. Harum aliquid quibusdam asperiores
                  sapiente. Sapiente omnis aut veritatis in earum, tempore quae
                  excepturi odio
                </motion.p>
              </div>
              {/* slider */}
