      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 ">
        ...
        <div className="flex-1 flex flex-col justify-center xl:text-left">
          ...
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2  xl:px-0">
            ...
            explicabo placeat officiis quod quae! Alias, ad, ipsam velit
            ...
            tempore consectetur hic dolore dolor porro molestias. Vero ipsam quo
            eius quaerat odio. Aliquid, corrupti?
          </p>
          {/* counter */}
          <div className="hidden md:flex md:max-w-xl xl:max-w-none mx-auto mb-8">
